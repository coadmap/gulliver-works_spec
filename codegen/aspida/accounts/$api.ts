...
import type { Methods as Methods0 } from './_account_id@string/academic_histories'
import type { Methods as Methods1 } from './_account_id@string/applicants'
import type { Methods as Methods2 } from './_account_id@string/followings'
import type { Methods as Methods3 } from './_account_id@string/hopes'
import type { Methods as Methods4 } from './_account_id@string/interested_lists'
import type { Methods as Methods5 } from './_account_id@string/mark_as_read'
import type { Methods as Methods6 } from './_account_id@string/notifications'
import type { Methods as Methods7 } from './_account_id@string/profile'
import type { Methods as Methods8 } from './_account_id@string/rooms'
import type { Methods as Methods9 } from './_account_id@string/work_histories'
...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  ...
  const PATH1 = '/academic_histories'
