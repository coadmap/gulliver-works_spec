...
import type { Methods as Methods0 } from './academic_histories/_id@string'
import type { Methods as Methods1 } from './accounts/_account_id@string/academic_histories'
import type { Methods as Methods2 } from './accounts/_account_id@string/applicants'
import type { Methods as Methods3 } from './accounts/_account_id@string/followings'
import type { Methods as Methods4 } from './accounts/_account_id@string/hopes'
import type { Methods as Methods5 } from './accounts/_account_id@string/interested_lists'
import type { Methods as Methods6 } from './accounts/_account_id@string/mark_as_read'
import type { Methods as Methods7 } from './accounts/_account_id@string/notifications'
import type { Methods as Methods8 } from './accounts/_account_id@string/profile'
import type { Methods as Methods9 } from './accounts/_account_id@string/rooms'
import type { Methods as Methods10 } from './accounts/_account_id@string/work_histories'
import type { Methods as Methods11 } from './accounts/_id@string'
import type { Methods as Methods12 } from './companies'
import type { Methods as Methods13 } from './companies/_company_id@string/recruitments'
import type { Methods as Methods14 } from './companies/_id@string'
import type { Methods as Methods15 } from './companies/recommended'
import type { Methods as Methods16 } from './employment_statuses'
import type { Methods as Methods17 } from './followings/_id@string'
import type { Methods as Methods18 } from './hopes/_id@string'
import type { Methods as Methods19 } from './industry_categories'
import type { Methods as Methods20 } from './interested_lists/_id@string'
import type { Methods as Methods21 } from './interested_lists/_interested_list_id@string/recruitments'
import type { Methods as Methods22 } from './interested_lists/_interested_list_id@string/recruitments/_id@string'
import type { Methods as Methods23 } from './messages/_id@string'
import type { Methods as Methods24 } from './occupation_main_categories'
...
import type { Methods as Methods30 } from './rooms/_room_id@string/messages'
import type { Methods as Methods31 } from './work_histories/_id@string'

const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  const prefix = (baseURL === undefined ? 'http://localhost:3000/v1' : baseURL).replace(/\/$/, '')
  const PATH0 = '/academic_histories'
  const PATH1 = '/accounts'
  const PATH2 = '/applicants'
  const PATH3 = '/followings'
  const PATH4 = '/hopes'
  const PATH5 = '/interested_lists'
  const PATH6 = '/mark_as_read'
  const PATH7 = '/notifications'
  const PATH8 = '/profile'
  const PATH9 = '/rooms'
  const PATH10 = '/work_histories'
  const PATH11 = '/companies'
  const PATH12 = '/recruitments'
  const PATH13 = '/companies/recommended'
  const PATH14 = '/employment_statuses'
  const PATH15 = '/industry_categories'
  const PATH16 = '/messages'
  const PATH17 = '/occupation_main_categories'
  ...
  return {
    ...
    interested_lists: {
      ...
      _interested_list_id: (val1: string) => {
        const prefix1 = `${PATH5}/${val1}`
